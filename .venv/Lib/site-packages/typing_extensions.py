...
if hasattr(warnings, "deprecated"):
    ...
    class deprecated:
        ...
        The warning specified by *section* will be emitted at runtime
        on use of deprecated objects. For functions, that happens on calls;
        for classes, on instantiation and on creation of subclasses.
        If the *section* is ``None``, no warning is emitted at runtime.
        The *stacklevel* determines where the
        warning is emitted. If it is ``1`` (the default), the warning
        is emitted at the direct caller of the deprecated object; if it
        is higher, it is emitted further up the stack.
        Static type checker behavior is not affected by the *section*
        ...
        def __init__(
            ...
            /,
            *,
            section: typing.Optional[typing.Type[Warning]] = DeprecationWarning,
            stacklevel: int = 1,
        ) -> None:
        ...
        def __call__(self, arg: _T, /) -> _T:
            ...
            if section is None:
                ...
                def __new__(cls, *args, **kwargs):
                    if cls is arg:
                        warnings.warn(msg, section=section, stacklevel=stacklevel + 1)
                ...
                raise TypeError(
                    "@deprecated decorator with non-None section must be applied to "
