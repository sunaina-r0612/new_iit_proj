...
class editable_wheel(Command):
    ...
    def _run_install(self, section: str):
        has_section = getattr(self.distribution, f"has_{section}", None)
        if has_section and has_section():
            _logger.info(f"Installing {section} as non editable")
            self.run_command(f"install_{section}")
