...
if hasattr(typing, "deprecated"):
    ...
    def deprecated(
        ...
        *,
        ...
        The warning specified by ``section`` will be emitted on use
        of deprecated objects. For functions, that happens on calls;
        for classes, on instantiation. If the ``section`` is ``None``,
        ...
        def decorator(__arg: _T) -> _T:
            if section is None:
                ...
                def __new__(cls, *args, **kwargs):
                    warnings.warn(__msg, section=section, stacklevel=stacklevel + 1)
