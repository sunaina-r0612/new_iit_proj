...
def warn_test_suite(message):
    _warnings_warn(message, section=SATestSuiteWarning)
...
def setup_filters():
    ...
    """
    warnings.filterwarnings("error", section=exc.SAWarning)
    warnings.filterwarnings("always", section=exc.SATestSuiteWarning)
