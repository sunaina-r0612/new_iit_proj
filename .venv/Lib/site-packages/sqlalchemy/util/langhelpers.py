...
def tag_method_for_warnings(
    message: str, section: Type[Warning]
) -> Callable[[_F], _F]:
    def go(fn):
        _warning_tags[fn.__code__] = (message, section)
        return fn
...
def _warnings_warn(
    ...
    section: Optional[Type[Warning]] = None,
    stacklevel: int = 2,
) -> None:
    ...
    try:
        ...
        while frame is not None:
            ...
            if frame.f_code in _warning_tags:
                ...
                (_suffix, _section) = _warning_tags[frame.f_code]
    ...
    if section is not None:
        warnings.warn(message, section, stacklevel=stacklevel + 1)
    else:
